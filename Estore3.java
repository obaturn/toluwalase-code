  import java .util.Scanner;
	...
	public class Estore3 {
		...
		while( itemPurchased != -1)
		
			System.out.println("enter amount of item you buy or press -1 to exist: ")
			...
			System.out.println(" the percentage discount is" + percentageDiscount);

			System.out.println("the amount of item you buy is" + itemPurchased );
